...
from BB_Draw import get_bb_video, get_bb_frame
import cv2
import os
...
parent_directory = r"D:\1 sem\AI CS6163\Assignments\Assignment 3 pt 2"

# Set input and output directory
video_path =  r"Drone Videos\Drone Tracking 1.mp4"
...
while True:
    ...
    centers = get_bb_frame(frame, model, names, object_class='Drone')
    print(names)
